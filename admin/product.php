    	...
    	<div class="row">
		  ...
		  <div class="col-md-10">
	  		...
	  		<div class="panel-title "><a href="beranda.php"><i class="glyphicon glyphicon-home"></i> Dashboard</a> \ Product</div>
				...
				<a href="inputproduct.php"><input type="submit" value="+ Add" class="btn btn-success"></a>
						...
						<?php
				          ...
				          while ($var=mysql_fetch_array($query)) {
				            ...
				            <tr>
				              ...
				              <td><?php echo "<a class='glyphicon glyphicon-edit' title='Edit' href='updateproduct.php?no=$var[no]'></a> |<a class='glyphicon glyphicon-trash' title='Hapus' href='deleteproduct.php?no=$var[no]'></a>"; ?></td>
				            </tr>
