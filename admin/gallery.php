    	...
    	<div class="row">
		  ...
		  <div class="col-md-10">
	  		...
	  		<div class="panel-title "><a href="beranda.php"><i class="glyphicon glyphicon-home"></i> Dashboard</a> \ Gallery</div>
				...
				<a href="inputgallery.php"><input type="submit" value="+ Add" class="btn btn-success"></a>
						...
						<tbody>
						 <?php
				          ...
				          while ($var=mysql_fetch_array($query)) {
				            ...
				            <tr>
				              <td><?php echo $no ?></td>
				              <td><?php echo $var ['id_gambar']; ?></td>
				              <td><img src="gambar/<?php echo $var['gambar'];?>" width="100" height="100"></td>
				              <td><?php echo $var ['keterangan']; ?></td>
				              <td><?php echo "<a class='glyphicon glyphicon-trash' title='Hapus' href='deletegallery.php?no=$var[no]'></a>"; ?></td>
				            </tr>
