    ...
    <div class="page-content">
    	<div class="row">
		  ...
		  <div class="col-md-10">
	  		...
	  		<div class="panel-title "><a href="beranda.php"><i class="glyphicon glyphicon-home"></i> Dashboard</a> \ Buyer</div>
  					...
  					<table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
						...
						<tbody>
						 <?php
				          ...
				          $query = mysql_query ("SELECT * FROM buyer");
				          $no=1;
				          while ($var=mysql_fetch_array($query)) {
				            ...
				            <tr>
				              ...
				              <td><?php echo $var ['id_produk']; ?></td>
				              <td><?php echo $var ['jumlah']; ?></td>
				              <td><?php echo $var ['date']; ?></td>
				              <td><?php echo $var ['catatan']; ?></td>
				              ...
				              <td><?php echo "<a class='glyphicon glyphicon-edit' title='Edit' href='updatebuyer.php?no=$var[no]'></a> |<a class='glyphicon glyphicon-trash' title='Hapus' href='deletebuyer.php?no=$var[no]'></a>"; ?></td>
				            </tr>
