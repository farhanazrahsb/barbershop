    ...
    <div class="page-content">
    	<div class="row">
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
					...
					<li class="current"><a href="price.php"><i class="glyphicon glyphicon-usd"></i> <span>Price</span></a></li>
		  ...
		  <div class="col-md-10">
	  		...
	  		<div class="panel-title "><a href="beranda.php"><i class="glyphicon glyphicon-home"></i> Dashboard</a> \ Price</div>

		  	</div>
  				<div class="panel-heading">
					<div class="panel-title"></div>
				</div>
				<a href="inputprice.php"><input type="submit" value="+ Add" class="btn btn-success"></a>
						...
						<tbody>
						 <?php
				          ...
				          while ($var=mysql_fetch_array($query)) {
				            ...
				            <tr>
				              <td><?php echo $no ?></td>
				              <td><?php echo $var ['id_price']; ?></td>
				              <td><?php echo $var ['model']; ?></td>
				              <td><?php echo $var ['harga']; ?></td>
				              <td><?php echo "<a class='glyphicon glyphicon-trash' title='Hapus' href='deleteprice.php?no=$var[no]'></a>"; ?></td>
				            </tr>
