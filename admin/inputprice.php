	  					...
	  					<div class="content-box-large">
			  				...
			  				<div class="panel-body">
								  ...
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-2 control-label">ID Price</label>
								    <div class="col-sm-10">
								      <input type="text" name="id_price" class="form-control" id="inputEmail3" placeholder="ID Price">
								    </div>
								  </div>
								  <div class="form-group">
	                            ...
	                            $query = mysql_query("INSERT INTO price (id_price,model,harga) VALUES ('$_POST[id_price]', '$_POST[model]', '$_POST[harga]')");

	                            if ($query){
	                            echo "<script>alert('Berhasil Menginput')</script>";
	                            echo "<meta http-equiv='refresh' content='1 url=inputprice.php'>";
	                            }else{
