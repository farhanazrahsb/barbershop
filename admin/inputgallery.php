		  ...
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
					...
					<li class="current"><a href="gallery.php"><i class="glyphicon glyphicon-picture"></i> <span>Gallery</span></a></li>
	  				...
	  				<div class="col-md-12">
	  					<div class="content-box-large">
			  				<div class="panel-heading">
					            <div class="panel-title"><a href="beranda.php"><i class="glyphicon glyphicon-home"></i> Dashboard</a> \ Gallery</div>
			  				...
			  				<div class="panel-body">
								  ...
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-2 control-label">ID Gallery</label>
								    <div class="col-sm-10">
								      <input type="text" name="id_gambar" class="form-control" id="inputEmail3" placeholder="ID Gallery">
								    </div>
								  </div>
								  <div class="form-group">
								    <label for="inputEmail3" class="col-sm-2 control-label">Gamabr</label>
								    <div class="col-sm-10">
	                            ...
	                            $query = mysql_query("INSERT INTO gallery (id_gambar,gambar,keterangan) VALUES ('$_POST[id_gambar]', '$nama', '$_POST[keterangan]')");

	                            if ($query){
	                            echo "<script>alert('Berhasil Menginput')</script>";
	                            echo "<meta http-equiv='refresh' content='1 url=inputgallery.php'>";
	                            }else{
