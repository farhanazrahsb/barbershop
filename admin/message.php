    ...
    <div class="page-content">
    	<div class="row">
		  <div class="col-md-2">
		  	<div class="sidebar content-box" style="display: block;">
                <ul class="nav">
					...
					<li class="current"><a href="message.php"><i class="glyphicon glyphicon-comment"></i> Message</a></li>
		  ...
		  <div class="col-md-10">
	  		...
	  		<div class="panel-title "><a href="beranda.php"><i class="glyphicon glyphicon-home"></i> Dashboard</a> \ Message</div>
						 ...
						 <?php
				          ...
				          while ($var=mysql_fetch_array($query)) {
				            ...
				            <tr>
				              ...
				              <td><?php echo "<a class='glyphicon glyphicon-trash' title='Hapus' href='deletemessage.php?no=$var[no]'></a>"; ?></td>
				            </tr>
