				...
				<div class="w3_content_agilleinfo_inner">
					<div class="container">
					     <div class="title-agileits">
                            <h2 class="w3l-agile">Our Product</h2> 
			             </div>
			             <button class="btn-lg btn-success"><a href="pesan.php" style="color: white;"><i class="glyphicon glyphicon-shopping-cart"></i> Order Here !</a></button>
				    ...
				    include ('koneksi/koneksi.php');
					  ...
					  $query = mysql_query("select * from produk order by id_produk desc LIMIT $mulai, $halaman")or die(mysql_error);
					  $no =$mulai+1;
						...
						<div class="grid">
							<figure class="effect-apollo">
								...
								<a class="example-image-link" href="admin/gambar/<?php echo $var['gambar'];?>" data-lightbox="example-set" data-title="<?php echo $var ['keterangan']; ?>">
									<img src="admin/gambar/<?php echo $var['gambar'];?>" alt="" width="100" height="350"/>
									<figcaption>
										<p>Detail</p>
									</figcaption>	
								</a>
							</figure>
							Kode Product = <b><?php echo $var ['id_produk']; ?></b><br>
							Harga = Rp <?php echo $var ['harga']; ?>,-00<br>
							Status = <b><?php echo $var ['status']; ?></b>
						</div>
						</div>
					<?php
				    }
